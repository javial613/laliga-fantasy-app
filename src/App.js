...
import ClauseWatcher from './components/Common/ClauseWatcher';
...
function AppRoutes() {
  ...
  return (
    <Layout>
      {/* Vigila las subidas de cláusula desde cualquier pantalla: si solo se
          rastrearan al abrir Equipos, harían falta dos visitas a esa pantalla
          el mismo día para detectar una. */}
      <ClauseWatcher />

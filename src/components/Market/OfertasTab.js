            ...
            <div className="p-5 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-gray-800 dark:text-white text-base flex items-center gap-1.5">
                  ...
                  <NextFixture
                    teamId={player.playerMaster.team?.id ?? player.playerMaster.teamId}

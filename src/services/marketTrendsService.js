...
class MarketTrendsService {
    constructor() {
        ...
        // La fuente publica la variación "últimas 24h" una vez al día, de
        // madrugada. Revalidar cada 6h asegura recoger el dato nuevo el mismo
        // día sin castigar a futbolfantasy: son 4 peticiones diarias como mucho.
     ...
     */
    async initialize() {
        // El corte por `initialized` debe seguir respetando la caducidad de la
        // caché: si solo se mirara el flag, el primer scrape de la sesión sería
        // el único, y una app de escritorio abierta durante días se quedaría
        // mostrando la variación del día que se abrió.

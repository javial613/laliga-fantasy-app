...
const adaptTeamDataResponse = createAdaptTeamDataResponse(loadTeamsMaster);
const adaptLineupResponse = createAdaptLineupResponse(loadTeamsMaster);
...
export const fantasyAPI = {
  ...
  // Equipos
  getTeamData: (leagueId, teamId) => api.get(`${CMP}/leagues/${leagueId}/teams/${teamId}?x-lang=es`).then(adaptTeamDataResponse),
  getTeamLineup: (teamId, week) => api.get(`${CMP}/teams/${teamId}/lineup/week/${week}?x-lang=es`).then(adaptLineupResponse),

  // Lineup Management
  getCurrentLineup: (teamId) => api.get(`${CMP}/teams/${teamId}/lineup?x-lang=es`).then(adaptLineupResponse),
